/** Explicit, bounded live integration check: two catalogue reads and one product in three shops. */
import { compare } from '../lib/compare.ts';
const result = await compare({ items: [{ code: '9000101810325', qty: 1 }], shopIds: ['auchan-007', 'rossmann-241', 'tesco-1025'], loyaltyChainIds: [], extraStopCost: 0 });
